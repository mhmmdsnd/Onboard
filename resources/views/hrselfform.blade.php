...
@section('title', 'Workflow HR Self-service ')
@section('content')
<div class="container">
            	...
            	<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">  
                            ...
                            <div class="checkbox">
                            <label>
                                {!! Form::checkbox('infra',$value['item_id'],in_array($value['item_id'],$list) ? 'checked' : '',['class'=>'ace','disabled'=>true]) !!}                               
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">  
                                ...
                                <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('ga','1',in_array($value['item_id'],$list) ? 'checked' : '',['class'=>'ace','disabled'=>true]) !!}    
                                    <span class="lbl">	{!! $value['item']->name !!}</span>
                                </label>
                                </div>
                                @endforeach
