...
<div class="container">
    {!! Form::open(array('method'=>'PUT','url'=>'company/'.$company->id,'class'=>'form-horizontal','id'=>'manage-company')) !!}
	<div class="form-group">
     	{!! Form::label('name', 'Group *', ['class' => 'col-sm-3 control-label no-padding-right']) !!}
        <div class="col-sm-9">
        <div class="clearfix">
			{!! Form::select('holding_id', $holding, $company->holdingId, ['id'=>'holding_id', 'placeholder' => 'Please Select...']) !!}
        </div>
    	</div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
        <div class="clearfix">
			{!! Form::text('company_name',$company->name, ['id'=>'company_name','class' => 'col-xs-10 col-sm-4']) !!}	
           </div>
    	</div>
    </div>
    <div class="form-group">
