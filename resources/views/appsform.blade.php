...
@section('title', 'Workflow IT Application ')
@section('content')
<div class="container">
    @if ($req->type_request == 'join') {!! Form::open(array('url'=>'ITApps','class'=>'form-horizontal')) !!}
	@else {!! Form::open(['class'=>'form-horizontal','action' => 'HRExitController@itstore']) !!} @endif
    ...
    {!! Form::hidden('type_request',$req->type_request,['id'=>'type_request']) !!}{!! Form::hidden('it_category',3) !!}
    <div class="col-sm-10 col-sm-offset-1">
	<div class="widget-box transparent">
		<div class="widget-header widget-header-large">
			<h3 class="widget-title grey lighter">
				<i class="ace-icon fa fa-leaf green"></i>
				IT Application - Suggested List
			</h3>
                ...
                <div class="col-sm-9">
                    <div>
                        <ul class="list-unstyled spaced">
                            <li>
                                <i class="ace-icon fa fa-caret-right blue"></i>Employee Name : <b class="red">{!! Form::hidden('id',$req->id) !!}
